...
Flows, information architecture, interaction, protocol/event shape, and other product choices that must be the same on every platform.
...
Platform-specific notes: file names, types, UI toolkit if needed.
